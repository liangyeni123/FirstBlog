...
<div id="wrapper">
      ...
      <ul>
        ...
        <li><a href="blog.html">博客</a>
        	<ul>
        		...
        		<li><a href="blog2.html">说说故事</a></li>
        		<li><a href="post.html">说说电影</a></li>
        		<li><a href="post2.html">说说音乐</a></li>
        	</ul>
        </li>
	...
	<div class="intro">尽情写下自己所想写的吧。可以是自己的故事、别人的故事，你的心情、想说的任何话。这里是“一本”开放的“杂志”，你可以在左边点击博客查看分类。</div>
		...
		<!-- Begin Post -->
		<div class="post">
		<a href="post.html"><img src="__PUBLIC__/style/images/art/slide1.jpg" alt="" /></a>
	...
	<div class="slider">
      ...
      <div>
        <img src="__PUBLIC__/style/images/art/slide2.jpg" alt=""/>
      </div>
      
      <div>
        <img src="__PUBLIC__/style/images/art/slide4.jpg" alt=""/>
      </div>
    </div>
    <!-- End Slider -->
		...
		<!-- Begin Post -->
		<div class="post">
		<a href="post.html"><img src="__PUBLIC__/style/images/art/slide3.jpg" alt="" /></a>
		...
		<!-- Begin Post -->
		<div class="post">
		<a href="post.html"><img src="__PUBLIC__/style/images/art/slide4.jpg" alt="" /></a>
    ...
    <div id="footer">
  	...
  	<h3>Popular Posts</h3>
			<ul class="popular-posts">
				<li>
					<a href="#"><img src="__PUBLIC__/style/images/art/s1.jpg" alt="" /></a>
					<h5><a href="#">Dolor Commodo Consectetur</a></h5>
					<span>26 Aug 2013 | <a href="#">21 Comments</a></span>
				</li>
				
				<li>
					<a href="#"><img src="__PUBLIC__/style/images/art/s2.jpg" alt="" /></a>
					<h5><a href="#">Dolor Commodo Consectetur</a></h5>
					<span>26 Aug 2013 | <a href="#">21 Comments</a></span>
				</li>
				
				<li>
					<a href="#"><img src="__PUBLIC__/style/images/art/s3.jpg" alt="" /></a>
					<h5><a href="#">Dolor Commodo Consectetur</a></h5>
					<span>26 Aug 2013 | <a href="#">21 Comments</a></span>
				</li>
